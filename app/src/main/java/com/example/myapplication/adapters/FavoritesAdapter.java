...
public class FavoritesAdapter extends RecyclerView.Adapter<FavoritesAdapter.ViewHolder> implements Filterable {
    ...
    FavoritesAdapter.ItemClick itemClick;

    public interface ItemClick {
        void onClick(Movie m);
    }

    public void setOnClickListener(FavoritesAdapter.ItemClick itemClick) {
        this.itemClick = itemClick;
    }

    public FavoritesAdapter(Context context, List<Movie> list) {
        this.list = list;
        ...
        return new Filter() {
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                ...
                if (filterResults != null)
                    ...
                    list = FavoriteManager.listFavorite();
    ...
    public FavoritesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new FavoritesAdapter.ViewHolder(layoutInflater.inflate(R.layout.adapter_popular_item, parent, false));
    }
